...
import com.postgresdb.data.GeCaEmpDocsPf;
...
/**
 *  Operations for service "postgresDB"
 *  01/23/2013 09:59:10
 * 
 */
    ...
    implements DataServiceManagerAccess, LiveDataService
{
    ...
    public GeCaEmpDocsPf getGeCaEmpDocsPfById(Integer id) {
        List<GeCaEmpDocsPf> rtn = ((List<GeCaEmpDocsPf> ) dsMgr.invoke(taskMgr.getQueryTask(), (PostgresDBConstants.getGeCaEmpDocsPfByIdQueryName), id));
        if (rtn.isEmpty()) {
            return null;
        } else {
            return rtn.get(0);
