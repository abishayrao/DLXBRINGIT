...
public class GeTbCnaeGrupo {
    ...
    private Set<com.postgresdb.data.GeTbCnaeClasse> geTbCnaeClasses = new HashSet<com.postgresdb.data.GeTbCnaeClasse>();
    ...
    public Set<com.postgresdb.data.GeTbCnaeClasse> getGeTbCnaeClasses() {
        return geTbCnaeClasses;
    }

    public void setGeTbCnaeClasses(Set<com.postgresdb.data.GeTbCnaeClasse> geTbCnaeClasses) {
