...
public class GeTbNatJurClasse {
    ...
    private Set<com.postgresdb.data.GeTbNatJuridica> geTbNatJuridicas = new HashSet<com.postgresdb.data.GeTbNatJuridica>();
    ...
    public Set<com.postgresdb.data.GeTbNatJuridica> getGeTbNatJuridicas() {
        return geTbNatJuridicas;
    }

    public void setGeTbNatJuridicas(Set<com.postgresdb.data.GeTbNatJuridica> geTbNatJuridicas) {
