...
public class SiProduto {
    ...
    private Set<com.postgresdb.data.SiSistema> siSistemas = new HashSet<com.postgresdb.data.SiSistema>();
    ...
    public Set<com.postgresdb.data.SiSistema> getSiSistemas() {
        return siSistemas;
    }

    public void setSiSistemas(Set<com.postgresdb.data.SiSistema> siSistemas) {
