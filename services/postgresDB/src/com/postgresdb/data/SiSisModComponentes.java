...
/**
 *  postgresDB.SiSisModComponentes
 *  01/23/2013 09:59:13
 * 
 */
public class SiSisModComponentes {
    ...
    private Set<com.postgresdb.data.SiSisModCompCampos> siSisModCompCamposes = new HashSet<com.postgresdb.data.SiSisModCompCampos>();
    private Set<com.postgresdb.data.SiSisVerComponentes> siSisVerComponenteses = new HashSet<com.postgresdb.data.SiSisVerComponentes>();
    private Set<com.postgresdb.data.SiSisModCompoHelp> siSisModCompoHelps = new HashSet<com.postgresdb.data.SiSisModCompoHelp>();
    ...
    public Set<com.postgresdb.data.SiSisModCompCampos> getSiSisModCompCamposes() {
        return siSisModCompCamposes;
    }

    public void setSiSisModCompCamposes(Set<com.postgresdb.data.SiSisModCompCampos> siSisModCompCamposes) {
        this.siSisModCompCamposes = siSisModCompCamposes;
    }

    public Set<com.postgresdb.data.SiSisVerComponentes> getSiSisVerComponenteses() {
        return siSisVerComponenteses;
    }

    public void setSiSisVerComponenteses(Set<com.postgresdb.data.SiSisVerComponentes> siSisVerComponenteses) {
        this.siSisVerComponenteses = siSisVerComponenteses;
    }

    public Set<com.postgresdb.data.SiSisModCompoHelp> getSiSisModCompoHelps() {
        return siSisModCompoHelps;
    }

    public void setSiSisModCompoHelps(Set<com.postgresdb.data.SiSisModCompoHelp> siSisModCompoHelps) {
