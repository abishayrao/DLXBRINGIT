...
import com.saasdb.data.GeTbBcAgencias;
    ...
    implements DataServiceManagerAccess, LiveDataService
{
    ...
    public GeTbBcAgencias getGeTbBcAgenciasById(Integer id) {
        List<GeTbBcAgencias> rtn = ((List<GeTbBcAgencias> ) dsMgr.invoke(taskMgr.getQueryTask(), (SaasDBConstants.getGeTbBcAgenciasByIdQueryName), id));
        if (rtn.isEmpty()) {
            return null;
        } else {
            return rtn.get(0);
