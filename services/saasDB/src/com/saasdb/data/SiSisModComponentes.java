...
public class SiSisModComponentes {
    ...
    private Set<com.saasdb.data.SiSisModCompCampos> siSisModCompCamposes = new HashSet<com.saasdb.data.SiSisModCompCampos>();
    private Set<com.saasdb.data.SiSisVerComponentes> siSisVerComponenteses = new HashSet<com.saasdb.data.SiSisVerComponentes>();
    private Set<com.saasdb.data.SiSisModCompoHelp> siSisModCompoHelps = new HashSet<com.saasdb.data.SiSisModCompoHelp>();
    ...
    public Set<com.saasdb.data.SiSisModCompCampos> getSiSisModCompCamposes() {
        return siSisModCompCamposes;
    }

    public void setSiSisModCompCamposes(Set<com.saasdb.data.SiSisModCompCampos> siSisModCompCamposes) {
        this.siSisModCompCamposes = siSisModCompCamposes;
    }

    public Set<com.saasdb.data.SiSisVerComponentes> getSiSisVerComponenteses() {
        return siSisVerComponenteses;
    }

    public void setSiSisVerComponenteses(Set<com.saasdb.data.SiSisVerComponentes> siSisVerComponenteses) {
        this.siSisVerComponenteses = siSisVerComponenteses;
    }

    public Set<com.saasdb.data.SiSisModCompoHelp> getSiSisModCompoHelps() {
        return siSisModCompoHelps;
    }

    public void setSiSisModCompoHelps(Set<com.saasdb.data.SiSisModCompoHelp> siSisModCompoHelps) {
