...
public class SiCliContatos {
    ...
    private com.saasdb.data.GeTbTiposTelefone geTbTiposTelefoneBySiclicontelatpid;
    private SiClientes siClientes;
    private com.saasdb.data.GeTbTiposTelefone geTbTiposTelefoneBySiclicontelbtpid;
    ...
    public com.saasdb.data.GeTbTiposTelefone getGeTbTiposTelefoneBySiclicontelatpid() {
        return geTbTiposTelefoneBySiclicontelatpid;
    }

    public void setGeTbTiposTelefoneBySiclicontelatpid(com.saasdb.data.GeTbTiposTelefone geTbTiposTelefoneBySiclicontelatpid) {
    ...
    public com.saasdb.data.GeTbTiposTelefone getGeTbTiposTelefoneBySiclicontelbtpid() {
        return geTbTiposTelefoneBySiclicontelbtpid;
    }

    public void setGeTbTiposTelefoneBySiclicontelbtpid(com.saasdb.data.GeTbTiposTelefone geTbTiposTelefoneBySiclicontelbtpid) {
